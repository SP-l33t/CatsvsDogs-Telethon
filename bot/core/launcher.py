...
from bot.utils import logger, config_utils, proxy_utils, CONFIG_PATH, SESSIONS_PATH, PROXIES_PATH, build_check, youtube_data
...
async def run_tasks():
    ...
    tasks.append(asyncio.create_task(youtube_data.update_youtube_routine()))
    tasks.append(asyncio.create_task(build_check.check_bot_update_loop()))
